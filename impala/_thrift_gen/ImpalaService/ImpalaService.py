...
class Processor(impala._thrift_gen.beeswax.BeeswaxService.Processor, Iface, TProcessor):
    ...
    def process_Cancel(self, seqid, iprot, oprot):
        ...
        try:
            ...
            raise
        except impala._thrift_gen.beeswax.ttypes.BeeswaxException as error:
            msg_type = TMessageType.REPLY
            result.error = error
    ...
    def process_CloseInsert(self, seqid, iprot, oprot):
        ...
        try:
            ...
            raise
        except impala._thrift_gen.beeswax.ttypes.QueryNotFoundException as error:
            msg_type = TMessageType.REPLY
            result.error = error
        except impala._thrift_gen.beeswax.ttypes.BeeswaxException as error2:
            msg_type = TMessageType.REPLY
...
Cancel_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'query_id', [impala._thrift_gen.beeswax.ttypes.QueryHandle, None], None, ),  # 1
)
...
Cancel_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [impala._thrift_gen.Status.ttypes.TStatus, None], None, ),  # 0
...
CloseInsert_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'handle', [impala._thrift_gen.beeswax.ttypes.QueryHandle, None], None, ),  # 1
)
...
GetExecSummary_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [impala._thrift_gen.ExecStats.ttypes.TExecSummary, None], None, ),  # 0
    (1, TType.STRUCT, 'error', [impala._thrift_gen.beeswax.ttypes.QueryNotFoundException, None], None, ),  # 1
    (2, TType.STRUCT, 'error2', [impala._thrift_gen.beeswax.ttypes.BeeswaxException, None], None, ),  # 2
)
