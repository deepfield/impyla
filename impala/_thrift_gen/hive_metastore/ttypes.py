...
class Table(object):
    ...
    def __init__(self, tableName=None, dbName=None, owner=None, createTime=None, lastAccessTime=None, retention=None, sd=None, partitionKeys=None, parameters=None, viewOriginalText=None, viewExpandedText=None, tableType=None, privileges=None, temporary=False, ownerType=1,):
...
class TxnInfo(object):
    ...
    def __init__(self, id=None, state=None, user=None, hostname=None, agentInfo="Unknown", heartbeatCount=0, metaInfo=None,):
        self.id = id
        self.state = state
        self.user = user
...
class LockComponent(object):
    ...
    def __init__(self, type=None, level=None, dbname=None, tablename=None, partitionname=None, operationType=5, isAcid=False,):
        self.type = type
        self.level = level
        self.dbname = dbname
        self.tablename = tablename
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i466 in range(_size462):
                        _key467 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        _val468 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
...
class ShowCompactResponseElement(object):
    ...
    def __init__(self, dbname=None, tablename=None, partitionname=None, type=None, state=None, workerid=None, start=None, runAs=None, hightestTxnId=None, metaInfo=None, endTime=None, hadoopJobId="None",):
        self.dbname = dbname
        self.tablename = tablename
        self.partitionname = partitionname
        self.type = type
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i482 in range(_size478):
                        _elem483 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i570 in range(_size566):
                        _elem571 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
            ...
            if fid == 7:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i577 in range(_size573):
                        _elem578 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
...
class GetPartitionsResponse(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i584 in range(_size580):
                        _elem585 = PartitionSpec()
                        _elem585.read(iprot)
                        self.partitionSpec.append(_elem585)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.partitionSpec is not None:
            ...
            for iter586 in self.partitionSpec:
                iter586.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i591 in range(_size587):
                        _elem592 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
